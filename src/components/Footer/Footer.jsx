      ...
      <footer id="footer">
        ...
        <section id="benefit-corporation" className="relative">
          ...
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			 viewBox="0 0 136.94 200.11" style="width: 3em; height: auto;"
			 xml:space="preserve">
		<style type="text/css">
			.st0{fill:#FFFFFF;}
		</style>
        ...
        <section className="theme-font text-lg text-center">
          <div className="wrap py-12">
            <p className="mb-6">Facilitator Cards is facilitated from Vermont 🍁 . <br/> Connect with us on <a href="https://www.instagram.com/facilitatorcards/" title="Instagram">Instagram</a>, <a href="https://www.youtube.com/facilitatorcards" title="YouTube">YouTube</a>, & <a href="https://www.linkedin.com/company/facilitatorcards" title="LinkedIn">LinkedIn</a>.</p>
