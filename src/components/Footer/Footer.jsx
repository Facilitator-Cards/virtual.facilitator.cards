    ...
    return (
      <footer id="footer">
        ...
        <section className="theme-font text-lg text-center">
          <div className="wrap py-12">
            <p className="mb-6">Facilitator Cards are facilitated from Vermont 🍁 . You can find us on <a href="https://www.facebook.com/facilitatorcards" title="Facebook">Facebook</a>, <a href="https://www.instagram.com/facilitatorcards" title="Instagram">Instagram</a>, & <a href="https://www.twitter.com/facilitatorcard" title="Twitter">Twitter</a>.</p>
